...
"color: rgb(255, 255, 255);")
        ...
        self.comment_text = QtWidgets.QPlainTextEdit(self.frame)
        self.comment_text.setGeometry(QtCore.QRect(5, 70, 331, 121))
...
"border: none")
    ...
    def retranslateUi(self, oneComment):
        ...
        self.user_pic_label.setText(_translate("oneComment", "TextLabel"))
        self.user_name_label.setText(_translate("oneComment", "TextLabel"))
        self.time_label.setText(_translate("oneComment", "TextLabel"))
